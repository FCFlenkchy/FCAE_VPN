...
- **[hev-socks5-tunnel](https://github.com/heiher/hev-socks5-tunnel)** — A lightweight C-based tunnel that transparently routes TUN device traffic through a SOCKS5 proxy. Powers the system-wide VPN TUN mode.

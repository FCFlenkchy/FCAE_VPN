...
<p align="center">
  <img src="windows_ui.png" alt="رابط کاربری ویندوز" height="400">
  &nbsp;
  <img src="android_ui.png" alt="رابط کاربری اندروید" height="400">
</p>
...
اگر مایلید از توسعه‌دهنده حمایت کنید، می‌توانید در شبکه TON (The Open Network) به این نشانی کمک کنید:

`UQAz9mcfJ5qlba97SPbrCw-Yt8OhhT58yG9PzARyu1Muz0jV`

فقط از شبکه TON استفاده کنید. کمک مالی کاملاً اختیاری است.

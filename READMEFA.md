...
- **[hev-socks5-tunnel](https://github.com/heiher/hev-socks5-tunnel)** — یک کتابخانه سبک مبتنی بر C که ترافیک دستگاه TUN را به‌صورت شفاف از طریق پروکسی SOCKS5 مسیریابی می‌کند. قدرت‌دهنده حالت TUN VPN در سطح سیستم.

...
### بخش‌هایی که به کمک نیاز دارند

- **مسیریابی TUN در macOS** — حالت TUN فعلی با tun2socks فقط ویندوز و لینوکس را پشتیبانی می‌کند. پیاده‌سازی مسیریابی macOS نیازمند کار است.
- **اسکن نقاط اتصال IPv6** — اسکنر در حال حاضر بیشتر بر IPv4 تمرکز دارد؛ کشف IPv6 نیاز به تست‌های واقعی بیشتری دارد.
- **ترجمه‌های رابط کاربری** — افزودن زبان‌های بیشتر به رابط‌های دسکتاپ و اندروید.
- **بهبود اثرانگشت پروتکل** — همیشه به دنبال راه‌هایی برای شبیه‌تر کردن ترافیک MASQUE و WireGuard به HTTPS مرورگر استاندارد.
